...
SUBTASK_NAMES = [
    ...
    "R2R_obj_color",
    "R2R_obj_place",
    "E2E_4way_shape_color",
    "E2E_4way_shape_place",
    "E2E_4way_obj_color",
    "E2E_4way_obj_place",
    "R2R_4way_shape_color",
    "R2R_4way_shape_place",
    "R2R_4way_obj_color",
    "R2R_4way_obj_place",
    "R2R_4way_1500_shape_color",
    "R2R_4way_1500_shape_place",
    "R2R_4way_1500_obj_color",
    "R2R_4way_1500_obj_place",
]
...
# doc_to_visual
# ============================================================
def doc_to_visual(doc: dict) -> list[str]:
    video_rel = doc["video"]
...
def _pred_letter_to_text(
    ...
    """pred_letter(A/B/C/...) → 해당 candidate 텍스트."""
...
def _save_direction_confusion_matrix(
    ...
    ax.set(
        ...
        title=(
            f"{task_name}\n"
            f"Accuracy: {acc:.2%} ({int(correct)}/{int(total)})"
        ),
    )
    plt.setp(
        ax.get_xticklabels(),
...
# ============================================================
# Aggregation function 생성
# ============================================================
def _make_aggregate(subtask: str, is_4way: bool = False):
    """subtask 이름으로 aggregate 함수를 생성."""
    task_name = f"vlm_direction_testbed_{subtask}"

    def aggregate(results: list[dict]) -> float:
        _log_per_direction_accuracy(results, task_name, is_4way=is_4way)
        return _save_direction_confusion_matrix(
            results, task_name, is_4way=is_4way
        )

    aggregate.__name__ = f"{subtask}_aggregate"
    return aggregate


# 8개 subtask에 대한 aggregate 함수를 모듈 수준에서 생성
E2E_shape_color_aggregate = _make_aggregate("E2E_shape_color")
E2E_shape_place_aggregate = _make_aggregate("E2E_shape_place")
E2E_obj_color_aggregate = _make_aggregate("E2E_obj_color")
E2E_obj_place_aggregate = _make_aggregate("E2E_obj_place")
R2R_shape_color_aggregate = _make_aggregate("R2R_shape_color")
R2R_shape_place_aggregate = _make_aggregate("R2R_shape_place")
R2R_obj_color_aggregate = _make_aggregate("R2R_obj_color")
R2R_obj_place_aggregate = _make_aggregate("R2R_obj_place")

# 4-way aggregate functions
E2E_4way_shape_color_aggregate = _make_aggregate(
    "E2E_4way_shape_color", is_4way=True
)
E2E_4way_shape_place_aggregate = _make_aggregate(
    "E2E_4way_shape_place", is_4way=True
)
E2E_4way_obj_color_aggregate = _make_aggregate(
    "E2E_4way_obj_color", is_4way=True
)
E2E_4way_obj_place_aggregate = _make_aggregate(
    "E2E_4way_obj_place", is_4way=True
)
R2R_4way_shape_color_aggregate = _make_aggregate(
    "R2R_4way_shape_color", is_4way=True
)
R2R_4way_shape_place_aggregate = _make_aggregate(
    "R2R_4way_shape_place", is_4way=True
)
R2R_4way_obj_color_aggregate = _make_aggregate(
    "R2R_4way_obj_color", is_4way=True
)
R2R_4way_obj_place_aggregate = _make_aggregate(
    "R2R_4way_obj_place", is_4way=True
)
R2R_4way_1500_shape_color_aggregate = _make_aggregate(
    "R2R_4way_1500_shape_color", is_4way=True
)
R2R_4way_1500_shape_place_aggregate = _make_aggregate(
    "R2R_4way_1500_shape_place", is_4way=True
)
R2R_4way_1500_obj_color_aggregate = _make_aggregate(
    "R2R_4way_1500_obj_color", is_4way=True
)
R2R_4way_1500_obj_place_aggregate = _make_aggregate(
    "R2R_4way_1500_obj_place", is_4way=True
)
